...
const char szDllFile[] = "C:\\Users\\Hacker\\source\\repos\\Game-Hacking\\Release\\Assault_Cube_Internal.dll";
const wchar_t szProc[] = L"ac_client.exe";
...
int main()
{
	...
	*/
	...
	while (bRet)
	{
		if (!wcscmp(szProc, PE32.szExeFile)) // PE32.szExeFile is the name of the executable file for the process (It doesn't contain path)
		{
